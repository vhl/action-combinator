...
describe('handlers', function() {
  ...
  describe('#addHandler', function() {
    it('adds a given handler for a given event to an element matching a given selector', function() {
  ...
  describe('#removeHandler', function() {
    it('removes the handler for a given event from an element matching a given selector', function() {
